...
To preview your changes to the website locally, you can build the site using Jekyll.
Follow the instructions in the [Jekyll documentation](https://jekyllrb.com/docs/installation/) to install Jekyll and its dependencies.

Once Jekyll is installed, navigate to the root directory of the repository and run the following command to build and serve the site locally:

```shell
bundle exec jekyll serve
```

This will start a local server, and you can view the website by opening your web browser and navigating to `http://localhost:4000`.

You can stop the server by pressing `CTRL + C` in the terminal.

To clear the local build, you can delete the `_site` directory in the root of the repository. Or use the command:
