...
* Updating the `#code-sprint-2026` channel every 45 minutes with a short update on your track's activity. Make sure to `#tag` your topic's channel. 
...
* Check the [agenda]({{ site.baseurl }}/2026/agenda) or the `#code-sprint-2026` channel on Slack for more detailed information.
...
<div class="aside" markdown="1">
The best way to contact us during the code sprint is to use the channel `#code-sprint-2026` on Slack.
</div>

### A note on bandwidth at the event

For those attending in-person, at The Wharf, we will be using the wifi network provided. If you need high bandwidth to download large amounts of data for your project we recommend using cloud services, preload on local machine, or bring usb sticks. If you have special circumstances or questions, please post your requirements to the `#code-sprint-2026` Slack channel and we can see how we can accommodate your needs.
